/* =============================================================================
   icons.js — the 37 icons this app uses, drawn inline.

   Originally these came from the Lucide CDN. They are inlined instead because a
   CDN that fails leaves the whole interface without icons, and because it drops
   a ~300KB script from the critical path. Same geometry (24x24, 2px stroke,
   round caps), ISC-licensed artwork from Lucide.
   ============================================================================= */
(function (root) {
  'use strict';
  ...
  var P = {
    ...
    'landmark': '<path d="M10 18v-7"/><path d="M11.12 2.2a2 2 0 0 1 1.76.01l7.87 3.84c.47.24.3.95-.23.95H3.47c-.53 0-.69-.71-.22-.95z"/><path d="M14 18v-7"/><path d="M18 18v-7"/><path d="M3 22h18"/><path d="M6 18v-7"/>',
    ...
    'sun-moon': '<path d="M12 8a2.83 2.83 0 1 0 4 4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="m4.93 4.93 1.41 1.41"/><path d="m17.66 17.66 1.41 1.41"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="m6.34 17.66-1.41 1.41"/><path d="m19.07 4.93-1.41 1.41"/>',
  ...
  root.Icons = { svg: svg, names: Object.keys(P) };
}(window));
